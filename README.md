...
- Create the following Python script `musicgen.py`:
...
- Set this shell script as the Musicgen binary for the bot using the `-musicgen-bin`
  command line argument.

#### Audiogen

- Create the following Python script `audiogen.py`:
...
- Set this shell script as the Audiogen binary for the bot using the `-audiogen-bin`
  command line argument.
